...
project = u'ORES'
copyright = u'2019 Wikimedia Scoring Platform team'
...
extlinks = {
            'issue': ('https://github.com/wikimedia/ores/issues/%s', '#'),
            'pr': ('https://github.com/wikimedia/ores/pull/%s', 'PR #'),
}
